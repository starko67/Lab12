...
class DrawingFrame extends JFrame {
    ...
    private final lab12.Shape[] shapes;
    ...
    public DrawingFrame(int wid, int hei) {
        ...
        shapes = new lab12.Shape[NUM_SHAPES];
        ...
        for (int i = 0; i < NUM_SHAPES; i++) {
            ...
            if (i % 2 == 0) {
                shapes[i] = new lab12.Circle(color, x, y, random.nextInt(50) + 30);
            } else {
                shapes[i] = new lab12.Rectangle(color, x, y, random.nextInt(100) + 50, random.nextInt(50) + 30);
            }
        }
    }
...
// Класс круга
class Circle extends lab12.Shape {
    private int radius;
...
class Rectangle extends lab12.Shape {
    private int width;
    private int height;
...
public class Main {
    public static void main(String[] args) {
        ...
        lab12.DrawingFrame frame = new lab12.DrawingFrame(wid,hei);
